...
@Component({
    selector: 'app-day-month-picker',
    templateUrl: './day-month-picker.component.html',
    styleUrls: ['./day-month-picker.component.scss'],
    providers: [
        { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => DayMonthPickerComponent), multi: true },
        { provide: DateAdapter, useClass: AppMonthAdapter },
        { provide: MAT_DATE_FORMATS, useValue: APP_MONTH_FORMATS }
    ]
})
export class DayMonthPickerComponent implements ControlValueAccessor, OnInit, OnDestroy {
