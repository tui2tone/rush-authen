...
import { AppYearAdapter, APP_YEAR_FORMATS } from './year-format';
...
@Component({
    ...
    providers: [
        ...
        { provide: DateAdapter, useClass: AppYearAdapter },
        { provide: MAT_DATE_FORMATS, useValue: APP_YEAR_FORMATS }
    ]
})
export class YearPickerComponent implements ControlValueAccessor, OnInit, OnDestroy {
    ...
    chosenYearHandler(normalizedYear: Moment, datepicker: MatDatepicker<Moment>) {
        const date = moment(normalizedYear)
        this.formControl.setValue(date.toDate());
        datepicker.close();
    }
}
